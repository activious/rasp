...
public class RevertProjectCommand implements Command {
   ...
   public RevertProjectCommand(String projectName) throws IOException,
                                                  SQLException {
   ...
   private AlbumEntity createAlbumByTool() {
      ...
      a.addTrack(createTrack(3, "Wings for Marie (Part 1)", dp.parse("6:11"),
                             artist));
      a.addTrack(createTrack(4, "10,000 Days (Wings Part 2)",
                             dp.parse("11:14"), artist));
      a.addTrack(createTrack(5, "The Pot", dp.parse("6:22"), artist));
      a.addTrack(createTrack(6, "Lipan Conjuring", dp.parse("1:11"), artist));
      a.addTrack(createTrack(7, "Lost Keys (Blame Hofmann)", dp.parse("3:46"),
                             artist));
   ...
   private AlbumEntity createAlbumByMetallica() {
      ...
      a.addTrack(createTrack(8, "Nothing Else Matters", dp.parse("6:29"),
                             artist));
      a.addTrack(createTrack(9, "Of Wolf and Man", dp.parse("4:16"), artist));
      a.addTrack(createTrack(10, "The God That Failed", dp.parse("5:05"),
                             artist));
      a.addTrack(createTrack(11, "My Friend of Misery", dp.parse("6:47"),
                             artist));
      a.addTrack(createTrack(12, "The Struggle Within", dp.parse("3:51"),
                             artist));
   ...
   private AlbumEntity createAlbum1() {
      ...
      a.addTrack(createTrack(1, "Allegro", dp.parse("  11:40"), artist,
                             composer));
      a.addTrack(createTrack(2, "Adagio", dp.parse("08:02"), artist, composer));
      a.addTrack(createTrack(3, "Menuetto - Allegro", dp.parse("03:04"),
                             artist, composer));
      a.addTrack(createTrack(4, "Allegro", dp.parse("09:49"), artist, composer));
      a.addTrack(createTrack(5, "Allegretto in B flat major",
                             dp.parse("04:51"), artist, composer));
      a.addTrack(createTrack(6, "Allegretto moderato in D flat major",
                             dp.parse("05:15"), artist, composer));
      ...
      a.addTrack(createTrack(10, "Andantino", dp.parse("08:22"), artist,
                             composer));
   ...
   private AlbumEntity createAlbum2() {
      ...
      a.addTrack(createTrack(4, "Det er i dag et vejr", dp.parse("2:08"),
                             artist));
      a.addTrack(createTrack(5, "Byens hotel", dp.parse("2:51"), artist));
      a.addTrack(createTrack(6, "Det rager mig en bønne", dp.parse("0:58"),
                             artist));
      a.addTrack(createTrack(7, "Hvis din far gir dig lov", dp.parse("3:21"),
                             artist));
      ...
      a.addTrack(createTrack(11, "Den rige og den fattige pige",
                             dp.parse("2:57"), artist));
      a.addTrack(createTrack(12, "De Fjorten Astronauter", dp.parse("2:19"),
                             artist));
      a.addTrack(createTrack(13, "På en gren I Vort Kvarter", dp.parse("2:40"),
                             artist));
      a.addTrack(createTrack(14, "Jacob Den Glade", dp.parse("3:34"), artist));
      a.addTrack(createTrack(15, "Christianshavn Kanal", dp.parse("2:08"),
                             artist));
   ...
   private AlbumEntity createAlbum3() {
      ...
      a.addTrack(createTrack(13, "Jeg Trækker Det Tilbage", dp.parse("3:12"),
                             artist));
   ...
   private AlbumEntity createAlbum4() {
      ...
      a.addTrack(createTrack(12, "Masterpiece Conspiracy", dp.parse("3:37"),
                             artist));
      a.addTrack(createTrack(13, "Without Jah, Nothin", dp.parse("3:11"),
                             artist));
      a.addTrack(createTrack(14, "Thinking About Forever", dp.parse("3:46"),
                             artist));
   ...
   private TrackEntity createTrack(int number, String title, int duration,
                                   ArtistEntity artist) {
   ...
   private TrackEntity createTrack(int number, String title, int duration,
                                   ArtistEntity artist, ArtistEntity composer) {
